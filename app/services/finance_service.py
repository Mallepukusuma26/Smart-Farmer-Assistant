...
class FinanceService:
    ...
    def add_expense(
        ...
        return self.repository.record_expense(
            farmer_id=farmer_id,
            category=category,
            amount=amount,
            farm_id=farm_id,
    ...
    def add_revenue(
        ...
        """Add crop harvest sale revenue transaction."""
        return self.repository.record_revenue(
            farmer_id=farmer_id,
            crop_id=crop_id,
    ...
    def get_financial_summary(self, farmer_id: int, total_land_acres: float = 1.0) -> Dict[str, Any]:
        """Compute full farm financial summary including P&L, ROI %, Cost/Acre, and category breakdowns."""
        total_exp = self.repository.calculate_total_expenses(farmer_id)
        total_rev = self.repository.calculate_total_revenue(farmer_id)
        ...
        expenses = self.repository.get_expenses_by_farmer(farmer_id)
        ...
        revenues = self.repository.get_revenues_by_farmer(farmer_id)
