"""
CropWaterStressIndexCWSIEngine — Thermal Infrared Canopy Water Stress Index (CWSI) Calculator.
...
@dataclass
class CropWaterStressIndexCWSIEngineParams:
...
class CropWaterStressIndexCWSIEngine:
    """Thermal Infrared Canopy Water Stress Index (CWSI) Calculator."""

    def __init__(self, params: Optional[Any] = None):
        self.params = params or CropWaterStressIndexCWSIEngineParams()

    def compute_core_metric(self, input_val_1: float, input_val_2: float, input_val_3: float = 5.0) -> Dict[str, Any]:
        """Calculate core domain metric for crop_water_stress_index_cwsi."""
        ...
        return {
            "module": "crop_water_stress_index_cwsi",
            "class_name": "CropWaterStressIndexCWSIEngine",
    ...
    def execute_multi_zone_simulation(self, zone_inputs: List[Dict[str, float]]) -> Dict[str, Any]:
        """Run multi-zone field spatial simulation for crop_water_stress_index_cwsi."""
        zone_results = []
        total_metric = 0.0
        ...
        return {
            "simulation_module": "crop_water_stress_index_cwsi",
