"""
ProcessingRiceMillingOutturnRatioEngine — Paddy Rice Parboiling Milling Recovery & Head Rice Yield (HRY).
...
@dataclass
class ProcessingRiceMillingOutturnRatioEngineSettings:
...
class ProcessingRiceMillingOutturnRatioEngine:
    """Paddy Rice Parboiling Milling Recovery & Head Rice Yield (HRY)."""

    def __init__(self, settings: Optional[Any] = None):
        self.settings = settings or ProcessingRiceMillingOutturnRatioEngineSettings()
    ...
    def calculate_domain_metric(
        ...
        """Calculate domain metric for processing_rice_milling_outturn_ratio."""
        ...
        payload = {
            "module_name": "processing_rice_milling_outturn_ratio",
            "class_name": "ProcessingRiceMillingOutturnRatioEngine",
            "metric_value": metric,
            "status": status,
    ...
    def process_grid_zones(self, zones: List[Dict[str, Any]]) -> Dict[str, Any]:
        """Process spatial grid zones for processing_rice_milling_outturn_ratio."""
        outcomes = []
        total_val = 0.0
        ...
        return {
            "module": "processing_rice_milling_outturn_ratio",
    ...
    def get_summary_report(self) -> Dict[str, Any]:
        """Summary report for processing_rice_milling_outturn_ratio."""
        return {
