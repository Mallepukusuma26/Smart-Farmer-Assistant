"""
ContractFarmingOutgrowerPayoutEngine — Outgrower Performance Reconciliation & Net Farmer Payout.
...
@dataclass
class ContractFarmingOutgrowerPayoutEngineParams:
...
class ContractFarmingOutgrowerPayoutEngine:
    """Outgrower Performance Reconciliation & Net Farmer Payout."""

    def __init__(self, params: Optional[Any] = None):
        self.params = params or ContractFarmingOutgrowerPayoutEngineParams()

    def compute_core_metric(self, input_val_1: float, input_val_2: float, input_val_3: float = 5.0) -> Dict[str, Any]:
        """Calculate core domain metric for contract_farming_outgrower_payout."""
        ...
        return {
            "module": "contract_farming_outgrower_payout",
            "class_name": "ContractFarmingOutgrowerPayoutEngine",
    ...
    def execute_multi_zone_simulation(self, zone_inputs: List[Dict[str, float]]) -> Dict[str, Any]:
        """Run multi-zone field spatial simulation for contract_farming_outgrower_payout."""
        zone_results = []
        total_metric = 0.0
        ...
        return {
            "simulation_module": "contract_farming_outgrower_payout",
