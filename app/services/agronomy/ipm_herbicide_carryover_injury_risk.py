"""
IPMHerbicideCarryoverInjuryRiskEngine — Soil Herbicide Persistence & Rotary Crop Carryover Injury Risk.
...
@dataclass
class IPMHerbicideCarryoverInjuryRiskEngineSettings:
...
class IPMHerbicideCarryoverInjuryRiskEngine:
    """Soil Herbicide Persistence & Rotary Crop Carryover Injury Risk."""

    def __init__(self, settings: Optional[Any] = None):
        self.settings = settings or IPMHerbicideCarryoverInjuryRiskEngineSettings()
    ...
    def calculate_domain_metric(
        ...
        """Calculate domain metric for ipm_herbicide_carryover_injury_risk."""
        ...
        payload = {
            "module_name": "ipm_herbicide_carryover_injury_risk",
            "class_name": "IPMHerbicideCarryoverInjuryRiskEngine",
            "metric_value": metric,
            "status": status,
    ...
    def process_grid_zones(self, zones: List[Dict[str, Any]]) -> Dict[str, Any]:
        """Process spatial grid zones for ipm_herbicide_carryover_injury_risk."""
        outcomes = []
        total_val = 0.0
        ...
        return {
            "module": "ipm_herbicide_carryover_injury_risk",
    ...
    def get_summary_report(self) -> Dict[str, Any]:
        """Summary report for ipm_herbicide_carryover_injury_risk."""
        return {
