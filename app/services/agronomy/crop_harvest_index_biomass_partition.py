"""
CropHarvestIndexBiomassPartitionEngine — Photosynthate Partitioning & Harvest Index (HI) Calculator.
...
@dataclass
class CropHarvestIndexBiomassPartitionEngineParams:
...
class CropHarvestIndexBiomassPartitionEngine:
    """Photosynthate Partitioning & Harvest Index (HI) Calculator."""

    def __init__(self, params: Optional[Any] = None):
        self.params = params or CropHarvestIndexBiomassPartitionEngineParams()

    def compute_core_metric(self, input_val_1: float, input_val_2: float, input_val_3: float = 5.0) -> Dict[str, Any]:
        """Calculate core domain metric for crop_harvest_index_biomass_partition."""
        ...
        return {
            "module": "crop_harvest_index_biomass_partition",
            "class_name": "CropHarvestIndexBiomassPartitionEngine",
    ...
    def execute_multi_zone_simulation(self, zone_inputs: List[Dict[str, float]]) -> Dict[str, Any]:
        """Run multi-zone field spatial simulation for crop_harvest_index_biomass_partition."""
        zone_results = []
        total_metric = 0.0
        ...
        return {
            "simulation_module": "crop_harvest_index_biomass_partition",
