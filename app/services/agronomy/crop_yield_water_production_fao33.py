"""
CropYieldWaterProductionFAO33Engine — FAO-33 Water Production Function & Yield Reduction Index.
...
@dataclass
class CropYieldWaterProductionFAO33EngineParams:
...
class CropYieldWaterProductionFAO33Engine:
    """FAO-33 Water Production Function & Yield Reduction Index."""

    def __init__(self, params: Optional[Any] = None):
        self.params = params or CropYieldWaterProductionFAO33EngineParams()

    def compute_core_metric(self, input_val_1: float, input_val_2: float, input_val_3: float = 5.0) -> Dict[str, Any]:
        """Calculate core domain metric for crop_yield_water_production_fao33."""
        ...
        return {
            "module": "crop_yield_water_production_fao33",
            "class_name": "CropYieldWaterProductionFAO33Engine",
    ...
    def execute_multi_zone_simulation(self, zone_inputs: List[Dict[str, float]]) -> Dict[str, Any]:
        """Run multi-zone field spatial simulation for crop_yield_water_production_fao33."""
        zone_results = []
        total_metric = 0.0
        ...
        return {
            "simulation_module": "crop_yield_water_production_fao33",
