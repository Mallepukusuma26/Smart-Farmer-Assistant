"""
IPMBotanicalExtractBiopesticideDoseEngine — Neem Azadirachtin & Essential Oil Biopesticide Formulation Dose.
...
@dataclass
class IPMBotanicalExtractBiopesticideDoseEngineSettings:
...
class IPMBotanicalExtractBiopesticideDoseEngine:
    """Neem Azadirachtin & Essential Oil Biopesticide Formulation Dose."""

    def __init__(self, settings: Optional[Any] = None):
        self.settings = settings or IPMBotanicalExtractBiopesticideDoseEngineSettings()
    ...
    def calculate_domain_metric(
        ...
        """Calculate domain metric for ipm_botanical_extract_biopesticide_dose."""
        ...
        payload = {
            "module_name": "ipm_botanical_extract_biopesticide_dose",
            "class_name": "IPMBotanicalExtractBiopesticideDoseEngine",
            "metric_value": metric,
            "status": status,
    ...
    def process_grid_zones(self, zones: List[Dict[str, Any]]) -> Dict[str, Any]:
        """Process spatial grid zones for ipm_botanical_extract_biopesticide_dose."""
        outcomes = []
        total_val = 0.0
        ...
        return {
            "module": "ipm_botanical_extract_biopesticide_dose",
    ...
    def get_summary_report(self) -> Dict[str, Any]:
        """Summary report for ipm_botanical_extract_biopesticide_dose."""
        return {
