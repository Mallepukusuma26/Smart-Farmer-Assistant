"""
CropSeedSowingRateCalculatorEngine — Target Population Sowing Rate & Germination Purity Adjuster.
...
@dataclass
class CropSeedSowingRateCalculatorEngineParams:
...
class CropSeedSowingRateCalculatorEngine:
    """Target Population Sowing Rate & Germination Purity Adjuster."""

    def __init__(self, params: Optional[Any] = None):
        self.params = params or CropSeedSowingRateCalculatorEngineParams()

    def compute_core_metric(self, input_val_1: float, input_val_2: float, input_val_3: float = 5.0) -> Dict[str, Any]:
        """Calculate core domain metric for crop_seed_sowing_rate_calculator."""
        ...
        return {
            "module": "crop_seed_sowing_rate_calculator",
            "class_name": "CropSeedSowingRateCalculatorEngine",
    ...
    def execute_multi_zone_simulation(self, zone_inputs: List[Dict[str, float]]) -> Dict[str, Any]:
        """Run multi-zone field spatial simulation for crop_seed_sowing_rate_calculator."""
        zone_results = []
        total_metric = 0.0
        ...
        return {
            "simulation_module": "crop_seed_sowing_rate_calculator",
