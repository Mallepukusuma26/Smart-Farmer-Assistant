"""
CropRotationMultiSeasonSequenceEngine — Multi-Season Cropping Sequence Optimization & Depletion Matrix.
...
@dataclass
class CropRotationMultiSeasonSequenceEngineParams:
...
class CropRotationMultiSeasonSequenceEngine:
    """Multi-Season Cropping Sequence Optimization & Depletion Matrix."""

    def __init__(self, params: Optional[Any] = None):
        self.params = params or CropRotationMultiSeasonSequenceEngineParams()

    def compute_core_metric(self, input_val_1: float, input_val_2: float, input_val_3: float = 5.0) -> Dict[str, Any]:
        """Calculate core domain metric for crop_rotation_multi_season_sequence."""
        ...
        return {
            "module": "crop_rotation_multi_season_sequence",
            "class_name": "CropRotationMultiSeasonSequenceEngine",
    ...
    def execute_multi_zone_simulation(self, zone_inputs: List[Dict[str, float]]) -> Dict[str, Any]:
        """Run multi-zone field spatial simulation for crop_rotation_multi_season_sequence."""
        zone_results = []
        total_metric = 0.0
        ...
        return {
            "simulation_module": "crop_rotation_multi_season_sequence",
