"""
WatershedFarmPondHarvestingCapacityEngine — Rainwater Harvesting Farm Pond Storage Sizing & Evaporation Loss.
...
@dataclass
class WatershedFarmPondHarvestingCapacityEngineConfiguration:
...
class WatershedFarmPondHarvestingCapacityEngine:
    """Rainwater Harvesting Farm Pond Storage Sizing & Evaporation Loss."""

    def __init__(self, config: Optional[Any] = None):
        self.config = config or WatershedFarmPondHarvestingCapacityEngineConfiguration()
    ...
    def compute_primary_domain_value(
        ...
        """Execute primary mathematical calculation for Rainwater Harvesting Farm Pond Storage Sizing & Evaporation Loss."""
        ...
        result_payload = {
            "module_key": "watershed_farm_pond_harvesting_capacity",
            "class_identifier": "WatershedFarmPondHarvestingCapacityEngine",
    ...
    def analyze_field_zone_grid(self, zone_grid_data: List[Dict[str, Any]]) -> Dict[str, Any]:
        """Perform multi-zone spatial grid evaluation for watershed_farm_pond_harvesting_capacity."""
        grid_outcomes = []
        metric_sum = 0.0
        critical_count = 0
    ...
    def generate_full_agronomic_report(self, farm_name: str, field_name: str) -> Dict[str, Any]:
        """Generate comprehensive agronomic summary report for watershed_farm_pond_harvesting_capacity."""
        return {
