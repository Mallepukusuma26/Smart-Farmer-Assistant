"""
FarmSolarPVPumpingSizeEngine — Solar PV Array Peak Power & Water Pumping Sizing.
...
@dataclass
class FarmSolarPVPumpingSizeEngineParams:
...
class FarmSolarPVPumpingSizeEngine:
    """Solar PV Array Peak Power & Water Pumping Sizing."""

    def __init__(self, params: Optional[Any] = None):
        self.params = params or FarmSolarPVPumpingSizeEngineParams()

    def compute_core_metric(self, input_val_1: float, input_val_2: float, input_val_3: float = 5.0) -> Dict[str, Any]:
        """Calculate core domain metric for farm_solar_pv_pumping_size."""
        ...
        return {
            "module": "farm_solar_pv_pumping_size",
            "class_name": "FarmSolarPVPumpingSizeEngine",
    ...
    def execute_multi_zone_simulation(self, zone_inputs: List[Dict[str, float]]) -> Dict[str, Any]:
        """Run multi-zone field spatial simulation for farm_solar_pv_pumping_size."""
        zone_results = []
        total_metric = 0.0
        ...
        return {
            "simulation_module": "farm_solar_pv_pumping_size",
