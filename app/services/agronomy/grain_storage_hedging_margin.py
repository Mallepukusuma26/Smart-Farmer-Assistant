"""
GrainStorageHedgingMarginEngine — Storage Basis Carrying Charge & Commodity Hedging Margin.
...
@dataclass
class GrainStorageHedgingMarginEngineParams:
...
class GrainStorageHedgingMarginEngine:
    """Storage Basis Carrying Charge & Commodity Hedging Margin."""

    def __init__(self, params: Optional[Any] = None):
        self.params = params or GrainStorageHedgingMarginEngineParams()

    def compute_core_metric(self, input_val_1: float, input_val_2: float, input_val_3: float = 5.0) -> Dict[str, Any]:
        """Calculate core domain metric for grain_storage_hedging_margin."""
        ...
        return {
            "module": "grain_storage_hedging_margin",
            "class_name": "GrainStorageHedgingMarginEngine",
    ...
    def execute_multi_zone_simulation(self, zone_inputs: List[Dict[str, float]]) -> Dict[str, Any]:
        """Run multi-zone field spatial simulation for grain_storage_hedging_margin."""
        zone_results = []
        total_metric = 0.0
        ...
        return {
            "simulation_module": "grain_storage_hedging_margin",
