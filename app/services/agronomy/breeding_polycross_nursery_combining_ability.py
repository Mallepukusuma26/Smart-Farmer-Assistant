"""
BreedingPolycrossNurseryCombiningAbilityEngine — Diallel Cross General & Specific Combining Ability (GCA/SCA).
...
@dataclass
class BreedingPolycrossNurseryCombiningAbilityEngineSettings:
...
class BreedingPolycrossNurseryCombiningAbilityEngine:
    """Diallel Cross General & Specific Combining Ability (GCA/SCA)."""

    def __init__(self, settings: Optional[Any] = None):
        self.settings = settings or BreedingPolycrossNurseryCombiningAbilityEngineSettings()
    ...
    def calculate_domain_metric(
        ...
        """Calculate domain metric for breeding_polycross_nursery_combining_ability."""
        ...
        payload = {
            "module_name": "breeding_polycross_nursery_combining_ability",
            "class_name": "BreedingPolycrossNurseryCombiningAbilityEngine",
            "metric_value": metric,
            "status": status,
    ...
    def process_grid_zones(self, zones: List[Dict[str, Any]]) -> Dict[str, Any]:
        """Process spatial grid zones for breeding_polycross_nursery_combining_ability."""
        outcomes = []
        total_val = 0.0
        ...
        return {
            "module": "breeding_polycross_nursery_combining_ability",
    ...
    def get_summary_report(self) -> Dict[str, Any]:
        """Summary report for breeding_polycross_nursery_combining_ability."""
        return {
