"""
CropEvapotranspirationFAO56PenmanEngine — FAO-56 Dual Crop Coefficient ET0 & ETc Irrigation Calculator.
...
@dataclass
class CropEvapotranspirationFAO56PenmanEngineParams:
...
class CropEvapotranspirationFAO56PenmanEngine:
    """FAO-56 Dual Crop Coefficient ET0 & ETc Irrigation Calculator."""

    def __init__(self, params: Optional[Any] = None):
        self.params = params or CropEvapotranspirationFAO56PenmanEngineParams()

    def compute_core_metric(self, input_val_1: float, input_val_2: float, input_val_3: float = 5.0) -> Dict[str, Any]:
        """Calculate core domain metric for crop_evapotranspiration_fao56_penman."""
        ...
        return {
            "module": "crop_evapotranspiration_fao56_penman",
            "class_name": "CropEvapotranspirationFAO56PenmanEngine",
    ...
    def execute_multi_zone_simulation(self, zone_inputs: List[Dict[str, float]]) -> Dict[str, Any]:
        """Run multi-zone field spatial simulation for crop_evapotranspiration_fao56_penman."""
        zone_results = []
        total_metric = 0.0
        ...
        return {
            "simulation_module": "crop_evapotranspiration_fao56_penman",
