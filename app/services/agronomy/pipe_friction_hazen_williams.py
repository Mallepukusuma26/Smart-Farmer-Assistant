"""
PipeFrictionHazenWilliamsEngine — Hazen-Williams Pipe Head Loss & Pressure Drop Calculator.
...
@dataclass
class PipeFrictionHazenWilliamsEngineParams:
...
class PipeFrictionHazenWilliamsEngine:
    """Hazen-Williams Pipe Head Loss & Pressure Drop Calculator."""

    def __init__(self, params: Optional[Any] = None):
        self.params = params or PipeFrictionHazenWilliamsEngineParams()

    def compute_core_metric(self, input_val_1: float, input_val_2: float, input_val_3: float = 5.0) -> Dict[str, Any]:
        """Calculate core domain metric for pipe_friction_hazen_williams."""
        ...
        return {
            "module": "pipe_friction_hazen_williams",
            "class_name": "PipeFrictionHazenWilliamsEngine",
    ...
    def execute_multi_zone_simulation(self, zone_inputs: List[Dict[str, float]]) -> Dict[str, Any]:
        """Run multi-zone field spatial simulation for pipe_friction_hazen_williams."""
        zone_results = []
        total_metric = 0.0
        ...
        return {
            "simulation_module": "pipe_friction_hazen_williams",
