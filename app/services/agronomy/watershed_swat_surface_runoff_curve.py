"""
WatershedSWATSurfaceRunoffCurveEngine — SCS Curve Number Watershed Surface Runoff Volume Model.
...
@dataclass
class WatershedSWATSurfaceRunoffCurveEngineConfiguration:
...
class WatershedSWATSurfaceRunoffCurveEngine:
    """SCS Curve Number Watershed Surface Runoff Volume Model."""

    def __init__(self, config: Optional[Any] = None):
        self.config = config or WatershedSWATSurfaceRunoffCurveEngineConfiguration()
    ...
    def compute_primary_domain_value(
        ...
        """Execute primary mathematical calculation for SCS Curve Number Watershed Surface Runoff Volume Model."""
        ...
        result_payload = {
            "module_key": "watershed_swat_surface_runoff_curve",
            "class_identifier": "WatershedSWATSurfaceRunoffCurveEngine",
    ...
    def analyze_field_zone_grid(self, zone_grid_data: List[Dict[str, Any]]) -> Dict[str, Any]:
        """Perform multi-zone spatial grid evaluation for watershed_swat_surface_runoff_curve."""
        grid_outcomes = []
        metric_sum = 0.0
        critical_count = 0
    ...
    def generate_full_agronomic_report(self, farm_name: str, field_name: str) -> Dict[str, Any]:
        """Generate comprehensive agronomic summary report for watershed_swat_surface_runoff_curve."""
        return {
