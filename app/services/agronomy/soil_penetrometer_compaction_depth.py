"""
SoilPenetrometerCompactionDepthEngine — Subsoil Cone Index Penetrometer Resistance & Root Barrier Depth.
...
@dataclass
class SoilPenetrometerCompactionDepthEngineParams:
...
class SoilPenetrometerCompactionDepthEngine:
    """Subsoil Cone Index Penetrometer Resistance & Root Barrier Depth."""

    def __init__(self, params: Optional[Any] = None):
        self.params = params or SoilPenetrometerCompactionDepthEngineParams()

    def compute_core_metric(self, input_val_1: float, input_val_2: float, input_val_3: float = 5.0) -> Dict[str, Any]:
        """Calculate core domain metric for soil_penetrometer_compaction_depth."""
        ...
        return {
            "module": "soil_penetrometer_compaction_depth",
            "class_name": "SoilPenetrometerCompactionDepthEngine",
    ...
    def execute_multi_zone_simulation(self, zone_inputs: List[Dict[str, float]]) -> Dict[str, Any]:
        """Run multi-zone field spatial simulation for soil_penetrometer_compaction_depth."""
        zone_results = []
        total_metric = 0.0
        ...
        return {
            "simulation_module": "soil_penetrometer_compaction_depth",
