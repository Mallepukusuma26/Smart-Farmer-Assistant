"""
AgronomyCropWaterStressCWSIThermalEngine — Thermal Infrared Canopy Water Stress Index (CWSI).
...
@dataclass
class AgronomyCropWaterStressCWSIThermalEngineConfig:
...
class AgronomyCropWaterStressCWSIThermalEngine:
    """Thermal Infrared Canopy Water Stress Index (CWSI)."""

    def __init__(self, config: Optional[Any] = None):
        self.config = config or AgronomyCropWaterStressCWSIThermalEngineConfig()
    ...
    def compute_metric(self, input_1: float, input_2: float, input_3: float = 10.0) -> Dict[str, Any]:
        ...
        res = {
            "module": "agronomy_crop_water_stress_cwsi_thermal",
            "class_name": "AgronomyCropWaterStressCWSIThermalEngine",
            "metric": metric,
    ...
    def evaluate_grid(self, zones: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        return {"module": "agronomy_crop_water_stress_cwsi_thermal", "zones_processed": len(results), "average_metric": avg, "breakdown": results}
