"""
ASABEMachineryFuelConsumptionEngine Controller.
REST API controllers for Tractor Fuel Rate & Repair Maintenance Cost Curves.
"""

from flask import jsonify, request
from app.services.agronomy.asabe_machinery_fuel_consumption import ASABEMachineryFuelConsumptionEngine

class ASABEMachineryFuelConsumptionEngineController:
    """Controller for ASABEMachineryFuelConsumptionEngine."""

    def __init__(self, service=None):
        self.service = service or ASABEMachineryFuelConsumptionEngine()
