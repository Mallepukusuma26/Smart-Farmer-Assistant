"""
LivestockForageDryMatterDemandEngine Controller.
REST API controllers for Ruminant Forage Dry Matter Intake & Feed Ration Balancer.
"""

from flask import jsonify, request
from app.services.agronomy.livestock_forage_dry_matter_demand import LivestockForageDryMatterDemandEngine

class LivestockForageDryMatterDemandEngineController:
    """Controller for LivestockForageDryMatterDemandEngine."""

    def __init__(self, service=None):
        self.service = service or LivestockForageDryMatterDemandEngine()
