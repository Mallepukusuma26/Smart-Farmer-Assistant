"""
PrecisionAgSentinelProxyEngine Controller.
REST API controllers for Sentinel-2 Multispectral Proxy Index & Vegetation Health.
"""

from flask import jsonify, request
from app.services.agronomy.precision_ag_sentinel_proxy_engine import PrecisionAgSentinelProxyEngine

class PrecisionAgSentinelProxyEngineController:
    """Controller for PrecisionAgSentinelProxyEngine."""

    def __init__(self, service=None):
        self.service = service or PrecisionAgSentinelProxyEngine()
