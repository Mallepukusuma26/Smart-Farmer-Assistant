"""
SoilMoistureTensiometerCalibrationEngine Controller.
REST API controllers for Soil Water Tension (kPa) to Volumetric Water Content Calibration.
"""

from flask import jsonify, request
from app.services.agronomy.soil_moisture_tensiometer_calibration import SoilMoistureTensiometerCalibrationEngine

class SoilMoistureTensiometerCalibrationEngineController:
    """Controller for SoilMoistureTensiometerCalibrationEngine."""

    def __init__(self, service=None):
        self.service = service or SoilMoistureTensiometerCalibrationEngine()
