"""
SoilAcidificationLimeRequirementEngine Controller.
REST API controllers for Buffer pH & Exchangeable Aluminum Lime Requirement Calculator.
"""

from flask import jsonify, request
from app.services.agronomy.soil_acidification_lime_requirement import SoilAcidificationLimeRequirementEngine

class SoilAcidificationLimeRequirementEngineController:
    """Controller for SoilAcidificationLimeRequirementEngine."""

    def __init__(self, service=None):
        self.service = service or SoilAcidificationLimeRequirementEngine()
