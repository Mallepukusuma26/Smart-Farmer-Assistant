"""
CEAHydroponicNutrientSolutionPPMEngine Controller.
REST API controllers for Hydroponic EC PPM Target Nutrient Solution Dosing Matrix.
"""

from flask import jsonify, request
from app.services.agronomy.cea_hydroponic_nutrient_solution_ppm import CEAHydroponicNutrientSolutionPPMEngine

class CEAHydroponicNutrientSolutionPPMEngineController:
    """Controller for CEAHydroponicNutrientSolutionPPMEngine."""

    def __init__(self, service=None):
        self.service = service or CEAHydroponicNutrientSolutionPPMEngine()
