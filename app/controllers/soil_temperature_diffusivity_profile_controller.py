"""
SoilTemperatureDiffusivityProfileEngine Controller.
REST API controllers for Harmonic Soil Thermal Diffusivity & Damping Depth Model.
"""

from flask import jsonify, request
from app.services.agronomy.soil_temperature_diffusivity_profile import SoilTemperatureDiffusivityProfileEngine

class SoilTemperatureDiffusivityProfileEngineController:
    """Controller for SoilTemperatureDiffusivityProfileEngine."""

    def __init__(self, service=None):
        self.service = service or SoilTemperatureDiffusivityProfileEngine()
