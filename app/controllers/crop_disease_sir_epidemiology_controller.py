"""
CropDiseaseSIREpidemiologyEngine Controller.
REST API controllers for Plant Pathogen SIR Epidemiological Disease Spread & Spore Germination.
"""

from flask import jsonify, request
from app.services.agronomy.crop_disease_sir_epidemiology import CropDiseaseSIREpidemiologyEngine

class CropDiseaseSIREpidemiologyEngineController:
    """Controller for CropDiseaseSIREpidemiologyEngine."""

    def __init__(self, service=None):
        self.service = service or CropDiseaseSIREpidemiologyEngine()
