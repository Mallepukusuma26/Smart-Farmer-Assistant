"""
SoilNitrogenMineralizationKineticsEngine Controller.
REST API controllers for First-Order Organic Nitrogen Mineralization Rate & Temperature Correction.
"""

from flask import jsonify, request
from app.services.agronomy.soil_nitrogen_mineralization_kinetics import SoilNitrogenMineralizationKineticsEngine

class SoilNitrogenMineralizationKineticsEngineController:
    """Controller for SoilNitrogenMineralizationKineticsEngine."""

    def __init__(self, service=None):
        self.service = service or SoilNitrogenMineralizationKineticsEngine()
