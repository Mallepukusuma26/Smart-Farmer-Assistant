"""
WatershedGroundwaterRechargeEngine Controller.
REST API controllers for Soil Deep Percolation & Aquifer Groundwater Recharge Rate.
"""

from flask import jsonify, request
from app.services.agronomy.watershed_groundwater_recharge_percolation import WatershedGroundwaterRechargeEngine

class WatershedGroundwaterRechargeEngineController:
    """Controller for WatershedGroundwaterRechargeEngine."""

    def __init__(self, service=None):
        self.service = service or WatershedGroundwaterRechargeEngine()
