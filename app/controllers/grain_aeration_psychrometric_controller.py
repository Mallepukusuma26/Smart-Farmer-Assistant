"""
Grain Aeration Cooling & Psychrometric EMC Engine Controller.
API endpoints for domain calculations and scenario evaluations.
"""

from flask import jsonify, request
from app.services.agronomy.grain_aeration_psychrometric_engine import GrainAerationEngine

class GrainAerationEngineController:
    """Controller for GrainAerationEngine."""

    def __init__(self, engine=None):
        self.engine = engine or GrainAerationEngine()
