"""
Dual Crop Coefficient FAO-56 Transpiration Engine Controller.
API endpoints for domain calculations and scenario evaluations.
"""

from flask import jsonify, request
from app.services.agronomy.crop_evapotranspiration_dual_kc_engine import DualKcEvapotranspirationEngine

class DualKcEvapotranspirationEngineController:
    """Controller for DualKcEvapotranspirationEngine."""

    def __init__(self, engine=None):
        self.engine = engine or DualKcEvapotranspirationEngine()
