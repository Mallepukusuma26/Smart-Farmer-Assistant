"""
Multi-Year Crop Rotation Soil Depletion Penalty Engine Controller.
API endpoints for domain calculations and scenario evaluations.
"""

from flask import jsonify, request
from app.services.agronomy.crop_rotation_soil_depletion_engine import CropRotationDepletionEngine

class CropRotationDepletionEngineController:
    """Controller for CropRotationDepletionEngine."""

    def __init__(self, engine=None):
        self.engine = engine or CropRotationDepletionEngine()
