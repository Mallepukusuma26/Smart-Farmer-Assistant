"""
GrainDryingPsychrometricEMCEngine Controller.
REST API controllers for Modified Chung-Pfost Equilibrium Moisture Content & Aeration.
"""

from flask import jsonify, request
from app.services.agronomy.grain_drying_psychrometric_emc import GrainDryingPsychrometricEMCEngine

class GrainDryingPsychrometricEMCEngineController:
    """Controller for GrainDryingPsychrometricEMCEngine."""

    def __init__(self, service=None):
        self.service = service or GrainDryingPsychrometricEMCEngine()
