"""
CropLodgingRiskStemStrengthEngine Controller.
REST API controllers for Stem Bending Moment & Wind Resistance Crop Lodging Index.
"""

from flask import jsonify, request
from app.services.agronomy.crop_lodging_risk_stem_strength import CropLodgingRiskStemStrengthEngine

class CropLodgingRiskStemStrengthEngineController:
    """Controller for CropLodgingRiskStemStrengthEngine."""

    def __init__(self, service=None):
        self.service = service or CropLodgingRiskStemStrengthEngine()
