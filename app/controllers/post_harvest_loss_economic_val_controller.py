"""
PostHarvestLossEconomicValEngine Controller.
REST API controllers for Grain Decay Loss Quantification & Cold Chain ROI Model.
"""

from flask import jsonify, request
from app.services.agronomy.post_harvest_loss_economic_val import PostHarvestLossEconomicValEngine

class PostHarvestLossEconomicValEngineController:
    """Controller for PostHarvestLossEconomicValEngine."""

    def __init__(self, service=None):
        self.service = service or PostHarvestLossEconomicValEngine()
