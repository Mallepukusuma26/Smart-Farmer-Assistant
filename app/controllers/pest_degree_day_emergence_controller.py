"""
Pest Degree-Day Emergence & Economic Injury Level Engine Controller.
API endpoints for domain calculations and scenario evaluations.
"""

from flask import jsonify, request
from app.services.agronomy.pest_degree_day_emergence_engine import PestEmergenceEILEngine

class PestEmergenceEILEngineController:
    """Controller for PestEmergenceEILEngine."""

    def __init__(self, engine=None):
        self.engine = engine or PestEmergenceEILEngine()
