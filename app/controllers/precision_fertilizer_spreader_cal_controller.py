"""
PrecisionFertilizerSpreaderCalEngine Controller.
REST API controllers for Centrifugal Fertilizer Spreader Swath Width & Overlap Profile.
"""

from flask import jsonify, request
from app.services.agronomy.precision_fertilizer_spreader_cal import PrecisionFertilizerSpreaderCalEngine

class PrecisionFertilizerSpreaderCalEngineController:
    """Controller for PrecisionFertilizerSpreaderCalEngine."""

    def __init__(self, service=None):
        self.service = service or PrecisionFertilizerSpreaderCalEngine()
