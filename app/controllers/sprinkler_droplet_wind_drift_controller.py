"""
SprinklerDropletWindDriftEngine Controller.
REST API controllers for Evaporative Loss & Wind Drift Losses for Overhead Sprinklers.
"""

from flask import jsonify, request
from app.services.agronomy.sprinkler_droplet_wind_drift import SprinklerDropletWindDriftEngine

class SprinklerDropletWindDriftEngineController:
    """Controller for SprinklerDropletWindDriftEngine."""

    def __init__(self, service=None):
        self.service = service or SprinklerDropletWindDriftEngine()
