"""
WatershedSubsurfaceDrainageTileEngine Controller.
REST API controllers for Hooghoudt Subsurface Tile Drain Spacing & Water Table Drawdown.
"""

from flask import jsonify, request
from app.services.agronomy.watershed_subsurface_drainage_tile_spacing import WatershedSubsurfaceDrainageTileEngine

class WatershedSubsurfaceDrainageTileEngineController:
    """Controller for WatershedSubsurfaceDrainageTileEngine."""

    def __init__(self, service=None):
        self.service = service or WatershedSubsurfaceDrainageTileEngine()
