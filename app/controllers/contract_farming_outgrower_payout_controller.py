"""
ContractFarmingOutgrowerPayoutEngine Controller.
REST API controllers for Outgrower Performance Reconciliation & Net Farmer Payout.
"""

from flask import jsonify, request
from app.services.agronomy.contract_farming_outgrower_payout import ContractFarmingOutgrowerPayoutEngine

class ContractFarmingOutgrowerPayoutEngineController:
    """Controller for ContractFarmingOutgrowerPayoutEngine."""

    def __init__(self, service=None):
        self.service = service or ContractFarmingOutgrowerPayoutEngine()
