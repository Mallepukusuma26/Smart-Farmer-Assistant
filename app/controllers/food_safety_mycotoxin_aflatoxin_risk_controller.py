"""
FoodSafetyMycotoxinAflatoxinRiskEngine Controller.
REST API controllers for Aspergillus Flavus Aflatoxin Contamination Weather Risk Model.
"""

from flask import jsonify, request
from app.services.agronomy.food_safety_mycotoxin_aflatoxin_risk import FoodSafetyMycotoxinAflatoxinRiskEngine

class FoodSafetyMycotoxinAflatoxinRiskEngineController:
    """Controller for FoodSafetyMycotoxinAflatoxinRiskEngine."""

    def __init__(self, service=None):
        self.service = service or FoodSafetyMycotoxinAflatoxinRiskEngine()
