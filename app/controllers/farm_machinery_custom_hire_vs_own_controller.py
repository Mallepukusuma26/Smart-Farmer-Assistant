"""
FarmMachineryCustomHireVsOwnEngine Controller.
REST API controllers for Break-Even Hectare Analysis for Custom Hire vs Purchase.
"""

from flask import jsonify, request
from app.services.agronomy.farm_machinery_custom_hire_vs_own import FarmMachineryCustomHireVsOwnEngine

class FarmMachineryCustomHireVsOwnEngineController:
    """Controller for FarmMachineryCustomHireVsOwnEngine."""

    def __init__(self, service=None):
        self.service = service or FarmMachineryCustomHireVsOwnEngine()
