"""
AgriculturalWaterTariffCostEngine Controller.
REST API controllers for Volumetric Irrigation Water Pricing & Pumping Cost Model.
"""

from flask import jsonify, request
from app.services.agronomy.agricultural_water_tariff_cost import AgriculturalWaterTariffCostEngine

class AgriculturalWaterTariffCostEngineController:
    """Controller for AgriculturalWaterTariffCostEngine."""

    def __init__(self, service=None):
        self.service = service or AgriculturalWaterTariffCostEngine()
