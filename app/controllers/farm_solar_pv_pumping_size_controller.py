"""
FarmSolarPVPumpingSizeEngine Controller.
REST API controllers for Solar PV Array Peak Power & Water Pumping Sizing.
"""

from flask import jsonify, request
from app.services.agronomy.farm_solar_pv_pumping_size import FarmSolarPVPumpingSizeEngine

class FarmSolarPVPumpingSizeEngineController:
    """Controller for FarmSolarPVPumpingSizeEngine."""

    def __init__(self, service=None):
        self.service = service or FarmSolarPVPumpingSizeEngine()
