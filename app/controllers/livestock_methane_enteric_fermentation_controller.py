"""
LivestockMethaneEntericFermentationEngine Controller.
REST API controllers for IPCC Tier 2 Enteric Fermentation Methane Emission Model.
"""

from flask import jsonify, request
from app.services.agronomy.livestock_methane_enteric_fermentation import LivestockMethaneEntericFermentationEngine

class LivestockMethaneEntericFermentationEngineController:
    """Controller for LivestockMethaneEntericFermentationEngine."""

    def __init__(self, service=None):
        self.service = service or LivestockMethaneEntericFermentationEngine()
