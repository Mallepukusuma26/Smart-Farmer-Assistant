"""
SeedHybridPurityElectrophoresisEngine Controller.
REST API controllers for Isozyme Electrophoresis Genetic Purity & Genetic Distance.
"""

from flask import jsonify, request
from app.services.agronomy.seed_hybrid_purity_electrophoresis import SeedHybridPurityElectrophoresisEngine

class SeedHybridPurityElectrophoresisEngineController:
    """Controller for SeedHybridPurityElectrophoresisEngine."""

    def __init__(self, service=None):
        self.service = service or SeedHybridPurityElectrophoresisEngine()
