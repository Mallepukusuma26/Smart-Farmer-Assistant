"""
FoodSafetyHACCPHazardMatrixEngine Controller.
REST API controllers for HACCP Critical Control Point (CCP) Hazard Analysis Risk Rating.
"""

from flask import jsonify, request
from app.services.agronomy.food_safety_haccp_hazard_matrix import FoodSafetyHACCPHazardMatrixEngine

class FoodSafetyHACCPHazardMatrixEngineController:
    """Controller for FoodSafetyHACCPHazardMatrixEngine."""

    def __init__(self, service=None):
        self.service = service or FoodSafetyHACCPHazardMatrixEngine()
