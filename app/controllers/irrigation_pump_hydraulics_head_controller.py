"""
IrrigationPumpHydraulicsHeadEngine Controller.
REST API controllers for Pumping Total Dynamic Head (TDH) & Brake Horsepower.
"""

from flask import jsonify, request
from app.services.agronomy.irrigation_pump_hydraulics_head import IrrigationPumpHydraulicsHeadEngine

class IrrigationPumpHydraulicsHeadEngineController:
    """Controller for IrrigationPumpHydraulicsHeadEngine."""

    def __init__(self, service=None):
        self.service = service or IrrigationPumpHydraulicsHeadEngine()
