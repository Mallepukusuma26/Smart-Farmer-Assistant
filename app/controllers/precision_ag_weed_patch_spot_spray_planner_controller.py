"""
PrecisionAgWeedPatchSpotSprayEngine Controller.
REST API controllers for Computer Vision Weed Patch Density & Spot Spray Map.
"""

from flask import jsonify, request
from app.services.agronomy.precision_ag_weed_patch_spot_spray_planner import PrecisionAgWeedPatchSpotSprayEngine

class PrecisionAgWeedPatchSpotSprayEngineController:
    """Controller for PrecisionAgWeedPatchSpotSprayEngine."""

    def __init__(self, service=None):
        self.service = service or PrecisionAgWeedPatchSpotSprayEngine()
