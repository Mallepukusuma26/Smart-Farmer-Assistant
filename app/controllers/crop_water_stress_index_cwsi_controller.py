"""
CropWaterStressIndexCWSIEngine Controller.
REST API controllers for Thermal Infrared Canopy Water Stress Index (CWSI) Calculator.
"""

from flask import jsonify, request
from app.services.agronomy.crop_water_stress_index_cwsi import CropWaterStressIndexCWSIEngine

class CropWaterStressIndexCWSIEngineController:
    """Controller for CropWaterStressIndexCWSIEngine."""

    def __init__(self, service=None):
        self.service = service or CropWaterStressIndexCWSIEngine()
