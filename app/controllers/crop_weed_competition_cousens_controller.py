"""
CropWeedCompetitionCousensEngine Controller.
REST API controllers for Cousens Hyperbolic Crop-Weed Yield Loss & CPWC Model.
"""

from flask import jsonify, request
from app.services.agronomy.crop_weed_competition_cousens import CropWeedCompetitionCousensEngine

class CropWeedCompetitionCousensEngineController:
    """Controller for CropWeedCompetitionCousensEngine."""

    def __init__(self, service=None):
        self.service = service or CropWeedCompetitionCousensEngine()
