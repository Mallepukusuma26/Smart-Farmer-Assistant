"""
PrecisionAgThermalDroughtStressEngine Controller.
REST API controllers for Thermal Infrared Field Drought Stress & Irrigation Priority Map.
"""

from flask import jsonify, request
from app.services.agronomy.precision_ag_thermal_drought_stress_mapper import PrecisionAgThermalDroughtStressEngine

class PrecisionAgThermalDroughtStressEngineController:
    """Controller for PrecisionAgThermalDroughtStressEngine."""

    def __init__(self, service=None):
        self.service = service or PrecisionAgThermalDroughtStressEngine()
