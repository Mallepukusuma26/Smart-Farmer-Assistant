"""
ASABEEquipmentDepreciationValueEngine Controller.
REST API controllers for Machine Remaining Value & Capital Recovery Depreciation.
"""

from flask import jsonify, request
from app.services.agronomy.asabe_equipment_depreciation_value import ASABEEquipmentDepreciationValueEngine

class ASABEEquipmentDepreciationValueEngineController:
    """Controller for ASABEEquipmentDepreciationValueEngine."""

    def __init__(self, service=None):
        self.service = service or ASABEEquipmentDepreciationValueEngine()
