"""
AgronomyRUSLE2ErosionToleranceEngine Controller.
"""

from flask import jsonify, request
from app.services.agronomy.agronomy_rusle2_erosion_tolerance import AgronomyRUSLE2ErosionToleranceEngine

class AgronomyRUSLE2ErosionToleranceEngineController:
    def __init__(self, service=None):
        self.service = service or AgronomyRUSLE2ErosionToleranceEngine()
