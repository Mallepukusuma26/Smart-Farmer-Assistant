"""
FoodSafetyColdChainQ10SpoilageEngine Controller.
REST API controllers for Cold Storage Temperature Abuse & Q10 Produce Spoilage Index.
"""

from flask import jsonify, request
from app.services.agronomy.food_safety_cold_chain_q10_spoilage import FoodSafetyColdChainQ10SpoilageEngine

class FoodSafetyColdChainQ10SpoilageEngineController:
    """Controller for FoodSafetyColdChainQ10SpoilageEngine."""

    def __init__(self, service=None):
        self.service = service or FoodSafetyColdChainQ10SpoilageEngine()
