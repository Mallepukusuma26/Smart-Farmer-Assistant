"""
CEAOrchardCanopyPruningSunlightEngine Controller.
REST API controllers for Deciduous Fruit Tree Training System & Intercepted Solar Radiation.
"""

from flask import jsonify, request
from app.services.agronomy.cea_orchard_canopy_pruning_sunlight import CEAOrchardCanopyPruningSunlightEngine

class CEAOrchardCanopyPruningSunlightEngineController:
    """Controller for CEAOrchardCanopyPruningSunlightEngine."""

    def __init__(self, service=None):
        self.service = service or CEAOrchardCanopyPruningSunlightEngine()
