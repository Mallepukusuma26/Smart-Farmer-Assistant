"""
SoilCationExchangeDynamicsEngine Controller.
REST API controllers for Cation Exchange Capacity (CEC) & Calcium Magnesium Potassium Ratios.
"""

from flask import jsonify, request
from app.services.agronomy.soil_cation_exchange_dynamics import SoilCationExchangeDynamicsEngine

class SoilCationExchangeDynamicsEngineController:
    """Controller for SoilCationExchangeDynamicsEngine."""

    def __init__(self, service=None):
        self.service = service or SoilCationExchangeDynamicsEngine()
