"""
RGB Spectral Vigor & Simulated NDVI Engine Controller.
API endpoints for domain calculations and scenario evaluations.
"""

from flask import jsonify, request
from app.services.agronomy.crop_canopy_reflectance_ndvi_engine import SpectralNDVIEngine

class SpectralNDVIEngineController:
    """Controller for SpectralNDVIEngine."""

    def __init__(self, engine=None):
        self.engine = engine or SpectralNDVIEngine()
