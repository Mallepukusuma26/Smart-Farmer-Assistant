"""
CommodityPriceSeasonalTrendEngine Controller.
REST API controllers for Agricultural Price Moving Average & Seasonal Index Decomposition.
"""

from flask import jsonify, request
from app.services.agronomy.commodity_price_seasonal_trend import CommodityPriceSeasonalTrendEngine

class CommodityPriceSeasonalTrendEngineController:
    """Controller for CommodityPriceSeasonalTrendEngine."""

    def __init__(self, service=None):
        self.service = service or CommodityPriceSeasonalTrendEngine()
