"""
ColdStorageRefrigerationLoadEngine Controller.
REST API controllers for Cold Room Produce Respiration & Refrigeration Cooling Load.
"""

from flask import jsonify, request
from app.services.agronomy.cold_storage_refrigeration_load import ColdStorageRefrigerationLoadEngine

class ColdStorageRefrigerationLoadEngineController:
    """Controller for ColdStorageRefrigerationLoadEngine."""

    def __init__(self, service=None):
        self.service = service or ColdStorageRefrigerationLoadEngine()
