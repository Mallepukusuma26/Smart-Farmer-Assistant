"""
FertilizerBlendMinimumCostLPEngine Controller.
REST API controllers for Simplex Linear Programming Minimum-Cost Fertilizer Blending.
"""

from flask import jsonify, request
from app.services.agronomy.fertilizer_blend_minimum_cost_lp import FertilizerBlendMinimumCostLPEngine

class FertilizerBlendMinimumCostLPEngineController:
    """Controller for FertilizerBlendMinimumCostLPEngine."""

    def __init__(self, service=None):
        self.service = service or FertilizerBlendMinimumCostLPEngine()
