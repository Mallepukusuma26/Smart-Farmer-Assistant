"""
SeedVigorAcceleratedAgingTestEngine Controller.
REST API controllers for Accelerated Aging Seed Vigor Index & Storage Longevity.
"""

from flask import jsonify, request
from app.services.agronomy.seed_vigor_accelerated_aging_test import SeedVigorAcceleratedAgingTestEngine

class SeedVigorAcceleratedAgingTestEngineController:
    """Controller for SeedVigorAcceleratedAgingTestEngine."""

    def __init__(self, service=None):
        self.service = service or SeedVigorAcceleratedAgingTestEngine()
