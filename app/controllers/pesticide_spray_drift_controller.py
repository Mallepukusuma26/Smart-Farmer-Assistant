"""
Droplet Size & Wind Spray Drift Deposition Engine Controller.
API endpoints for domain calculations and scenario evaluations.
"""

from flask import jsonify, request
from app.services.agronomy.pesticide_spray_drift_engine import SprayDriftDepositionEngine

class SprayDriftDepositionEngineController:
    """Controller for SprayDriftDepositionEngine."""

    def __init__(self, engine=None):
        self.engine = engine or SprayDriftDepositionEngine()
