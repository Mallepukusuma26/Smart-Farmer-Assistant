"""
WatershedSWATSurfaceRunoffCurveEngine Controller.
REST API controllers for SCS Curve Number Watershed Surface Runoff Volume Model.
"""

from flask import jsonify, request
from app.services.agronomy.watershed_swat_surface_runoff_curve import WatershedSWATSurfaceRunoffCurveEngine

class WatershedSWATSurfaceRunoffCurveEngineController:
    """Controller for WatershedSWATSurfaceRunoffCurveEngine."""

    def __init__(self, service=None):
        self.service = service or WatershedSWATSurfaceRunoffCurveEngine()
