"""
CropInsuranceActuarialRatingEngine Controller.
REST API controllers for Parametric Yield Risk Protection & Actuarial Premium Rating.
"""

from flask import jsonify, request
from app.services.agronomy.crop_insurance_actuarial_rating import CropInsuranceActuarialRatingEngine

class CropInsuranceActuarialRatingEngineController:
    """Controller for CropInsuranceActuarialRatingEngine."""

    def __init__(self, service=None):
        self.service = service or CropInsuranceActuarialRatingEngine()
