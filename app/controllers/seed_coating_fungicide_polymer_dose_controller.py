"""
SeedCoatingFungicidePolymerDoseEngine Controller.
REST API controllers for Seed Polymer Film Coating & Chemical Active Ingredient Dose.
"""

from flask import jsonify, request
from app.services.agronomy.seed_coating_fungicide_polymer_dose import SeedCoatingFungicidePolymerDoseEngine

class SeedCoatingFungicidePolymerDoseEngineController:
    """Controller for SeedCoatingFungicidePolymerDoseEngine."""

    def __init__(self, service=None):
        self.service = service or SeedCoatingFungicidePolymerDoseEngine()
