"""
PrecisionAgCanopyHeightDroneLidarEngine Controller.
REST API controllers for Drone LiDAR Canopy Height & Biomass Volume Estimator.
"""

from flask import jsonify, request
from app.services.agronomy.precision_ag_canopy_height_drone_lidar import PrecisionAgCanopyHeightDroneLidarEngine

class PrecisionAgCanopyHeightDroneLidarEngineController:
    """Controller for PrecisionAgCanopyHeightDroneLidarEngine."""

    def __init__(self, service=None):
        self.service = service or PrecisionAgCanopyHeightDroneLidarEngine()
