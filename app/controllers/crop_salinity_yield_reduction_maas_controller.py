"""
CropSalinityYieldReductionMaasEngine Controller.
REST API controllers for Maas-Hoffman Crop Salinity Yield Threshold & Slope Reduction.
"""

from flask import jsonify, request
from app.services.agronomy.crop_salinity_yield_reduction_maas import CropSalinityYieldReductionMaasEngine

class CropSalinityYieldReductionMaasEngineController:
    """Controller for CropSalinityYieldReductionMaasEngine."""

    def __init__(self, service=None):
        self.service = service or CropSalinityYieldReductionMaasEngine()
