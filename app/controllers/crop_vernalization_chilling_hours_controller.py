"""
CropVernalizationChillingHoursEngine Controller.
REST API controllers for Utah & Dynamic Model Chilling Hours Vernalization Accumulator.
"""

from flask import jsonify, request
from app.services.agronomy.crop_vernalization_chilling_hours import CropVernalizationChillingHoursEngine

class CropVernalizationChillingHoursEngineController:
    """Controller for CropVernalizationChillingHoursEngine."""

    def __init__(self, service=None):
        self.service = service or CropVernalizationChillingHoursEngine()
