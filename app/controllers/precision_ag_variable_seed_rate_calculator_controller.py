"""
PrecisionAgVariableSeedRateEngine Controller.
REST API controllers for Variable Seed Rate Application (VRA-Seed) Map Generator.
"""

from flask import jsonify, request
from app.services.agronomy.precision_ag_variable_seed_rate_calculator import PrecisionAgVariableSeedRateEngine

class PrecisionAgVariableSeedRateEngineController:
    """Controller for PrecisionAgVariableSeedRateEngine."""

    def __init__(self, service=None):
        self.service = service or PrecisionAgVariableSeedRateEngine()
