"""
SoilMicrobialCarbonKineticsEngine Controller.
REST API controllers for Soil Microbial Biomass Carbon & Nitrogen Decomposition Kinetics.
"""

from flask import jsonify, request
from app.services.agronomy.soil_microbial_carbon_kinetics import SoilMicrobialCarbonKineticsEngine

class SoilMicrobialCarbonKineticsEngineController:
    """Controller for SoilMicrobialCarbonKineticsEngine."""

    def __init__(self, service=None):
        self.service = service or SoilMicrobialCarbonKineticsEngine()
