"""
SoilFertilityMultiMetricIndexEngine Controller.
REST API controllers for Integrated Chemical Physical & Biological Soil Fertility Index.
"""

from flask import jsonify, request
from app.services.agronomy.soil_fertility_multi_metric_index import SoilFertilityMultiMetricIndexEngine

class SoilFertilityMultiMetricIndexEngineController:
    """Controller for SoilFertilityMultiMetricIndexEngine."""

    def __init__(self, service=None):
        self.service = service or SoilFertilityMultiMetricIndexEngine()
