"""
CropEvapotranspirationFAO56PenmanEngine Controller.
REST API controllers for FAO-56 Dual Crop Coefficient ET0 & ETc Irrigation Calculator.
"""

from flask import jsonify, request
from app.services.agronomy.crop_evapotranspiration_fao56_penman import CropEvapotranspirationFAO56PenmanEngine

class CropEvapotranspirationFAO56PenmanEngineController:
    """Controller for CropEvapotranspirationFAO56PenmanEngine."""

    def __init__(self, service=None):
        self.service = service or CropEvapotranspirationFAO56PenmanEngine()
