"""
CEAVerticalFarmLEDSpectrumPAREngine Controller.
REST API controllers for LED Photoperiod Spectrum Efficiency & Daily Light Integral (DLI).
"""

from flask import jsonify, request
from app.services.agronomy.cea_vertical_farm_led_spectrum_par import CEAVerticalFarmLEDSpectrumPAREngine

class CEAVerticalFarmLEDSpectrumPAREngineController:
    """Controller for CEAVerticalFarmLEDSpectrumPAREngine."""

    def __init__(self, service=None):
        self.service = service or CEAVerticalFarmLEDSpectrumPAREngine()
