"""
LivestockSilvopastureGrazingCapacityEngine Controller.
REST API controllers for Silvopasture Carrying Capacity & Rotational Grazing Days.
"""

from flask import jsonify, request
from app.services.agronomy.livestock_silvopasture_grazing_capacity import LivestockSilvopastureGrazingCapacityEngine

class LivestockSilvopastureGrazingCapacityEngineController:
    """Controller for LivestockSilvopastureGrazingCapacityEngine."""

    def __init__(self, service=None):
        self.service = service or LivestockSilvopastureGrazingCapacityEngine()
