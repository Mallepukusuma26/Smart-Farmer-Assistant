"""
SoilPenetrometerCompactionDepthEngine Controller.
REST API controllers for Subsoil Cone Index Penetrometer Resistance & Root Barrier Depth.
"""

from flask import jsonify, request
from app.services.agronomy.soil_penetrometer_compaction_depth import SoilPenetrometerCompactionDepthEngine

class SoilPenetrometerCompactionDepthEngineController:
    """Controller for SoilPenetrometerCompactionDepthEngine."""

    def __init__(self, service=None):
        self.service = service or SoilPenetrometerCompactionDepthEngine()
