"""
Greenhouse Vapor Pressure Deficit & Heating Load Engine Controller.
API endpoints for domain calculations and scenario evaluations.
"""

from flask import jsonify, request
from app.services.agronomy.greenhouse_microclimate_vpd_engine import GreenhouseVPDEngine

class GreenhouseVPDEngineController:
    """Controller for GreenhouseVPDEngine."""

    def __init__(self, engine=None):
        self.engine = engine or GreenhouseVPDEngine()
