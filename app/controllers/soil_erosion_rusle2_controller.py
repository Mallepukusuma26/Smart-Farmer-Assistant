"""
RUSLE2 Soil Erosion Loss & Erosivity Engine Controller.
API endpoints for domain calculations and scenario evaluations.
"""

from flask import jsonify, request
from app.services.agronomy.soil_erosion_rusle2_engine import RUSLE2SoilErosionEngine

class RUSLE2SoilErosionEngineController:
    """Controller for RUSLE2SoilErosionEngine."""

    def __init__(self, engine=None):
        self.engine = engine or RUSLE2SoilErosionEngine()
