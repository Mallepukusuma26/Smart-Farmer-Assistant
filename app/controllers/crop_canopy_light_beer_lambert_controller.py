"""
CropCanopyLightBeerLambertEngine Controller.
REST API controllers for Beer-Lambert PAR Light Extinction & Sunlit-Shaded LAI.
"""

from flask import jsonify, request
from app.services.agronomy.crop_canopy_light_beer_lambert import CropCanopyLightBeerLambertEngine

class CropCanopyLightBeerLambertEngineController:
    """Controller for CropCanopyLightBeerLambertEngine."""

    def __init__(self, service=None):
        self.service = service or CropCanopyLightBeerLambertEngine()
