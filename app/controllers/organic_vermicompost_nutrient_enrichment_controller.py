"""
OrganicVermicompostNutrientEnrichmentEngine Controller.
REST API controllers for Vermicompost Microbial Activity & Humic Acid Extraction Rate.
"""

from flask import jsonify, request
from app.services.agronomy.organic_vermicompost_nutrient_enrichment import OrganicVermicompostNutrientEnrichmentEngine

class OrganicVermicompostNutrientEnrichmentEngineController:
    """Controller for OrganicVermicompostNutrientEnrichmentEngine."""

    def __init__(self, service=None):
        self.service = service or OrganicVermicompostNutrientEnrichmentEngine()
