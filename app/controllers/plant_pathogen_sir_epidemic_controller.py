"""
Plant Disease SIR Epidemic Progression Engine Controller.
API endpoints for domain calculations and scenario evaluations.
"""

from flask import jsonify, request
from app.services.agronomy.plant_pathogen_sir_epidemic_engine import PathogenSIREpidemicEngine

class PathogenSIREpidemicEngineController:
    """Controller for PathogenSIREpidemicEngine."""

    def __init__(self, engine=None):
        self.engine = engine or PathogenSIREpidemicEngine()
