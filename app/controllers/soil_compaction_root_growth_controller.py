"""
Soil Penetrometer Compaction & Root Penetration Engine Controller.
API endpoints for domain calculations and scenario evaluations.
"""

from flask import jsonify, request
from app.services.agronomy.soil_compaction_root_growth_engine import SoilCompactionRootEngine

class SoilCompactionRootEngineController:
    """Controller for SoilCompactionRootEngine."""

    def __init__(self, engine=None):
        self.engine = engine or SoilCompactionRootEngine()
