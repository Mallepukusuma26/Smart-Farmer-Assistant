"""
AgronomyASABETractorFuelRateEngine Controller.
"""

from flask import jsonify, request
from app.services.agronomy.agronomy_asabe_tractor_fuel_rate import AgronomyASABETractorFuelRateEngine

class AgronomyASABETractorFuelRateEngineController:
    def __init__(self, service=None):
        self.service = service or AgronomyASABETractorFuelRateEngine()
