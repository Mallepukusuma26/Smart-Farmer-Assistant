"""
CEATissueCultureMicropropagationEngine Controller.
REST API controllers for In-Vitro Tissue Culture Multiplication & Rooting Media.
"""

from flask import jsonify, request
from app.services.agronomy.cea_tissue_culture_micropropagation import CEATissueCultureMicropropagationEngine

class CEATissueCultureMicropropagationEngineController:
    """Controller for CEATissueCultureMicropropagationEngine."""

    def __init__(self, service=None):
        self.service = service or CEATissueCultureMicropropagationEngine()
