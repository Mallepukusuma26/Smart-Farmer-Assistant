"""
CropHarvestIndexBiomassPartitionEngine Controller.
REST API controllers for Photosynthate Partitioning & Harvest Index (HI) Calculator.
"""

from flask import jsonify, request
from app.services.agronomy.crop_harvest_index_biomass_partition import CropHarvestIndexBiomassPartitionEngine

class CropHarvestIndexBiomassPartitionEngineController:
    """Controller for CropHarvestIndexBiomassPartitionEngine."""

    def __init__(self, service=None):
        self.service = service or CropHarvestIndexBiomassPartitionEngine()
