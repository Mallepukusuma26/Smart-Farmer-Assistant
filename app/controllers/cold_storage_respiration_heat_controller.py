"""
Cold Storage Fruit Respiration & Heat Load Engine Controller.
API endpoints for domain calculations and scenario evaluations.
"""

from flask import jsonify, request
from app.services.agronomy.cold_storage_respiration_heat_engine import ColdStorageRespirationEngine

class ColdStorageRespirationEngineController:
    """Controller for ColdStorageRespirationEngine."""

    def __init__(self, engine=None):
        self.engine = engine or ColdStorageRespirationEngine()
