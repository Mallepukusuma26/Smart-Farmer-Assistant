"""
SoilTraceElementBioavailabilityEngine Controller.
REST API controllers for Micronutrient Iron Zinc Manganese Boron Availability Index.
"""

from flask import jsonify, request
from app.services.agronomy.soil_trace_element_bioavailability import SoilTraceElementBioavailabilityEngine

class SoilTraceElementBioavailabilityEngineController:
    """Controller for SoilTraceElementBioavailabilityEngine."""

    def __init__(self, service=None):
        self.service = service or SoilTraceElementBioavailabilityEngine()
