"""
CEAPolyhouseShadingNetTransmissivityEngine Controller.
REST API controllers for Polyhouse Shade Net Solar Reduction & Transpiration Cooling.
"""

from flask import jsonify, request
from app.services.agronomy.cea_polyhouse_shading_net_transmissivity import CEAPolyhouseShadingNetTransmissivityEngine

class CEAPolyhouseShadingNetTransmissivityEngineController:
    """Controller for CEAPolyhouseShadingNetTransmissivityEngine."""

    def __init__(self, service=None):
        self.service = service or CEAPolyhouseShadingNetTransmissivityEngine()
