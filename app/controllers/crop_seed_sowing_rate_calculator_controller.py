"""
CropSeedSowingRateCalculatorEngine Controller.
REST API controllers for Target Population Sowing Rate & Germination Purity Adjuster.
"""

from flask import jsonify, request
from app.services.agronomy.crop_seed_sowing_rate_calculator import CropSeedSowingRateCalculatorEngine

class CropSeedSowingRateCalculatorEngineController:
    """Controller for CropSeedSowingRateCalculatorEngine."""

    def __init__(self, service=None):
        self.service = service or CropSeedSowingRateCalculatorEngine()
