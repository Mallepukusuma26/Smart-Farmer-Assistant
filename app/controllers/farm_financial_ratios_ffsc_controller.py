"""
FarmFinancialRatiosFSCSEngine Controller.
REST API controllers for Farm Financial Standards Council Liquidity Solvency Profitability.
"""

from flask import jsonify, request
from app.services.agronomy.farm_financial_ratios_ffsc import FarmFinancialRatiosFSCSEngine

class FarmFinancialRatiosFSCSEngineController:
    """Controller for FarmFinancialRatiosFSCSEngine."""

    def __init__(self, service=None):
        self.service = service or FarmFinancialRatiosFSCSEngine()
