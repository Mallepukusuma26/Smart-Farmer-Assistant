"""
SoilErosionRUSLEErosivityEngine Controller.
REST API controllers for Revised Universal Soil Loss Equation (RUSLE) Annual Erosion Metric.
"""

from flask import jsonify, request
from app.services.agronomy.soil_erosion_rusle_erosivity import SoilErosionRUSLEErosivityEngine

class SoilErosionRUSLEErosivityEngineController:
    """Controller for SoilErosionRUSLEErosivityEngine."""

    def __init__(self, service=None):
        self.service = service or SoilErosionRUSLEErosivityEngine()
