"""
Irrigation Pump Curve & Friction Loss Hydraulics Engine Controller.
API endpoints for domain calculations and scenario evaluations.
"""

from flask import jsonify, request
from app.services.agronomy.irrigation_pump_hydraulics_engine import PumpHydraulicsEngine

class PumpHydraulicsEngineController:
    """Controller for PumpHydraulicsEngine."""

    def __init__(self, engine=None):
        self.engine = engine or PumpHydraulicsEngine()
