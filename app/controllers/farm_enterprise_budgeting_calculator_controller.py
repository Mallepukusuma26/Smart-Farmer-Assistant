"""
FarmEnterpriseBudgetingCalculatorEngine Controller.
REST API controllers for Multi-Crop Enterprise Budget & Partial Budget Profit Optimizer.
"""

from flask import jsonify, request
from app.services.agronomy.farm_enterprise_budgeting_calculator import FarmEnterpriseBudgetingCalculatorEngine

class FarmEnterpriseBudgetingCalculatorEngineController:
    """Controller for FarmEnterpriseBudgetingCalculatorEngine."""

    def __init__(self, service=None):
        self.service = service or FarmEnterpriseBudgetingCalculatorEngine()
