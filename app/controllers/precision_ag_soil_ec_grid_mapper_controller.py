"""
PrecisionAgSoilECGridMapperEngine Controller.
REST API controllers for Apparent Soil EC Spatial Grid Interpolation & Management Zones.
"""

from flask import jsonify, request
from app.services.agronomy.precision_ag_soil_ec_grid_mapper import PrecisionAgSoilECGridMapperEngine

class PrecisionAgSoilECGridMapperEngineController:
    """Controller for PrecisionAgSoilECGridMapperEngine."""

    def __init__(self, service=None):
        self.service = service or PrecisionAgSoilECGridMapperEngine()
