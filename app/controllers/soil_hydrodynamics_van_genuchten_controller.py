"""
SoilHydrodynamicsVanGenuchtenEngine Controller.
REST API controllers for van Genuchten Unsaturated Soil Water Retention & Hydraulic Conductivity.
"""

from flask import jsonify, request
from app.services.agronomy.soil_hydrodynamics_van_genuchten import SoilHydrodynamicsVanGenuchtenEngine

class SoilHydrodynamicsVanGenuchtenEngineController:
    """Controller for SoilHydrodynamicsVanGenuchtenEngine."""

    def __init__(self, service=None):
        self.service = service or SoilHydrodynamicsVanGenuchtenEngine()
