"""
SoilPhosphorusSorptionLangmuirEngine Controller.
REST API controllers for Langmuir & Freundlich Soil Phosphorus Sorption Isotherms.
"""

from flask import jsonify, request
from app.services.agronomy.soil_phosphorus_sorption_langmuir import SoilPhosphorusSorptionLangmuirEngine

class SoilPhosphorusSorptionLangmuirEngineController:
    """Controller for SoilPhosphorusSorptionLangmuirEngine."""

    def __init__(self, service=None):
        self.service = service or SoilPhosphorusSorptionLangmuirEngine()
