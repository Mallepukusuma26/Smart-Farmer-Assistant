"""
SeedHarvestMoistureShatterRiskEngine Controller.
REST API controllers for Field Grain Shattering Risk & Harvesting Moisture Threshold.
"""

from flask import jsonify, request
from app.services.agronomy.seed_harvest_moisture_shatter_risk import SeedHarvestMoistureShatterRiskEngine

class SeedHarvestMoistureShatterRiskEngineController:
    """Controller for SeedHarvestMoistureShatterRiskEngine."""

    def __init__(self, service=None):
        self.service = service or SeedHarvestMoistureShatterRiskEngine()
