"""
CropYieldWaterProductionFAO33Engine Controller.
REST API controllers for FAO-33 Water Production Function & Yield Reduction Index.
"""

from flask import jsonify, request
from app.services.agronomy.crop_yield_water_production_fao33 import CropYieldWaterProductionFAO33Engine

class CropYieldWaterProductionFAO33EngineController:
    """Controller for CropYieldWaterProductionFAO33Engine."""

    def __init__(self, service=None):
        self.service = service or CropYieldWaterProductionFAO33Engine()
