"""
PrecisionVRAROICalculatorEngine Controller.
REST API controllers for Variable Rate Application Input Savings & Hardware ROI.
"""

from flask import jsonify, request
from app.services.agronomy.precision_vra_roi_calculator import PrecisionVRAROICalculatorEngine

class PrecisionVRAROICalculatorEngineController:
    """Controller for PrecisionVRAROICalculatorEngine."""

    def __init__(self, service=None):
        self.service = service or PrecisionVRAROICalculatorEngine()
