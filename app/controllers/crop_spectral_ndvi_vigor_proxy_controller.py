"""
CropSpectralNDVIVigorProxyEngine Controller.
REST API controllers for RGB Drone Imagery Spectral Proxy NDVI & Vigor Index.
"""

from flask import jsonify, request
from app.services.agronomy.crop_spectral_ndvi_vigor_proxy import CropSpectralNDVIVigorProxyEngine

class CropSpectralNDVIVigorProxyEngineController:
    """Controller for CropSpectralNDVIVigorProxyEngine."""

    def __init__(self, service=None):
        self.service = service or CropSpectralNDVIVigorProxyEngine()
