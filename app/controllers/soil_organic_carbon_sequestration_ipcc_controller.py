"""
SoilOrganicCarbonSequestrationIPCCEngine Controller.
REST API controllers for IPCC Tier 2 Soil Carbon Stock Change & Offsets Calculator.
"""

from flask import jsonify, request
from app.services.agronomy.soil_organic_carbon_sequestration_ipcc import SoilOrganicCarbonSequestrationIPCCEngine

class SoilOrganicCarbonSequestrationIPCCEngineController:
    """Controller for SoilOrganicCarbonSequestrationIPCCEngine."""

    def __init__(self, service=None):
        self.service = service or SoilOrganicCarbonSequestrationIPCCEngine()
