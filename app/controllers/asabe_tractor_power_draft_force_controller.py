"""
ASABETractorPowerDraftForceEngine Controller.
REST API controllers for ASABE D497 Implement Draft Force & Drawbar Horsepower.
"""

from flask import jsonify, request
from app.services.agronomy.asabe_tractor_power_draft_force import ASABETractorPowerDraftForceEngine

class ASABETractorPowerDraftForceEngineController:
    """Controller for ASABETractorPowerDraftForceEngine."""

    def __init__(self, service=None):
        self.service = service or ASABETractorPowerDraftForceEngine()
