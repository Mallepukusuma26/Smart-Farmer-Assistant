"""
CropPhenologyThermalTimeGDDEngine Controller.
REST API controllers for Growing Degree Days (GDD) & Thermal Time Stage Prediction.
"""

from flask import jsonify, request
from app.services.agronomy.crop_phenology_thermal_time_gdd import CropPhenologyThermalTimeGDDEngine

class CropPhenologyThermalTimeGDDEngineController:
    """Controller for CropPhenologyThermalTimeGDDEngine."""

    def __init__(self, service=None):
        self.service = service or CropPhenologyThermalTimeGDDEngine()
