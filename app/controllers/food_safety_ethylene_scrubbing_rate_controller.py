"""
FoodSafetyEthyleneScrubbingRateEngine Controller.
REST API controllers for Cold Room Ethylene Production & Potassium Permanganate Scrubber.
"""

from flask import jsonify, request
from app.services.agronomy.food_safety_ethylene_scrubbing_rate import FoodSafetyEthyleneScrubbingRateEngine

class FoodSafetyEthyleneScrubbingRateEngineController:
    """Controller for FoodSafetyEthyleneScrubbingRateEngine."""

    def __init__(self, service=None):
        self.service = service or FoodSafetyEthyleneScrubbingRateEngine()
