"""
PrecisionAgYieldMonitorDataCleanerEngine Controller.
REST API controllers for Combine Harvester Yield Monitor Sensor Cleaning & Anomaly Filter.
"""

from flask import jsonify, request
from app.services.agronomy.precision_ag_yield_monitor_data_cleaner import PrecisionAgYieldMonitorDataCleanerEngine

class PrecisionAgYieldMonitorDataCleanerEngineController:
    """Controller for PrecisionAgYieldMonitorDataCleanerEngine."""

    def __init__(self, service=None):
        self.service = service or PrecisionAgYieldMonitorDataCleanerEngine()
