"""
CropFrostDamagePredictionEngine Controller.
REST API controllers for Critical Thermal Freeze Threshold & Frost Protection Radiative Model.
"""

from flask import jsonify, request
from app.services.agronomy.crop_frost_damage_prediction import CropFrostDamagePredictionEngine

class CropFrostDamagePredictionEngineController:
    """Controller for CropFrostDamagePredictionEngine."""

    def __init__(self, service=None):
        self.service = service or CropFrostDamagePredictionEngine()
