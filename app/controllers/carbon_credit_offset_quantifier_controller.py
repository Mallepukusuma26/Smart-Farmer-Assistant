"""
CarbonCreditOffsetQuantifierEngine Controller.
REST API controllers for Verified Regenerative Carbon Offsets (tCO2e) & Income.
"""

from flask import jsonify, request
from app.services.agronomy.carbon_credit_offset_quantifier import CarbonCreditOffsetQuantifierEngine

class CarbonCreditOffsetQuantifierEngineController:
    """Controller for CarbonCreditOffsetQuantifierEngine."""

    def __init__(self, service=None):
        self.service = service or CarbonCreditOffsetQuantifierEngine()
