"""
CropRotationMultiSeasonSequenceEngine Controller.
REST API controllers for Multi-Season Cropping Sequence Optimization & Depletion Matrix.
"""

from flask import jsonify, request
from app.services.agronomy.crop_rotation_multi_season_sequence import CropRotationMultiSeasonSequenceEngine

class CropRotationMultiSeasonSequenceEngineController:
    """Controller for CropRotationMultiSeasonSequenceEngine."""

    def __init__(self, service=None):
        self.service = service or CropRotationMultiSeasonSequenceEngine()
