"""
Organic Compost Thermophilic Phase Kinetics Engine Controller.
API endpoints for domain calculations and scenario evaluations.
"""

from flask import jsonify, request
from app.services.agronomy.compost_thermal_kinetics_engine import CompostKineticsEngine

class CompostKineticsEngineController:
    """Controller for CompostKineticsEngine."""

    def __init__(self, engine=None):
        self.engine = engine or CompostKineticsEngine()
