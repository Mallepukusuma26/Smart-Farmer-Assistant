"""
GrainStorageHedgingMarginEngine Controller.
REST API controllers for Storage Basis Carrying Charge & Commodity Hedging Margin.
"""

from flask import jsonify, request
from app.services.agronomy.grain_storage_hedging_margin import GrainStorageHedgingMarginEngine

class GrainStorageHedgingMarginEngineController:
    """Controller for GrainStorageHedgingMarginEngine."""

    def __init__(self, service=None):
        self.service = service or GrainStorageHedgingMarginEngine()
