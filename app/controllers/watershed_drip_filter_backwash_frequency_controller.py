"""
WatershedDripFilterBackwashEngine Controller.
REST API controllers for Disc/Media Filter Pressure Differential & Automated Backwash Timing.
"""

from flask import jsonify, request
from app.services.agronomy.watershed_drip_filter_backwash_frequency import WatershedDripFilterBackwashEngine

class WatershedDripFilterBackwashEngineController:
    """Controller for WatershedDripFilterBackwashEngine."""

    def __init__(self, service=None):
        self.service = service or WatershedDripFilterBackwashEngine()
