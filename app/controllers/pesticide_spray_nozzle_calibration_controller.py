"""
PesticideSprayNozzleCalibrationEngine Controller.
REST API controllers for Boom Sprayer Application Volume (L/ha) & Nozzle Flow Rate.
"""

from flask import jsonify, request
from app.services.agronomy.pesticide_spray_nozzle_calibration import PesticideSprayNozzleCalibrationEngine

class PesticideSprayNozzleCalibrationEngineController:
    """Controller for PesticideSprayNozzleCalibrationEngine."""

    def __init__(self, service=None):
        self.service = service or PesticideSprayNozzleCalibrationEngine()
