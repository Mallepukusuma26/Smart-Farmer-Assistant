"""
LivestockManureNutrientExcretionIPCCEngine Controller.
REST API controllers for IPCC Tier 1 Manure Nitrogen & Phosphorus Excretion Engine.
"""

from flask import jsonify, request
from app.services.agronomy.livestock_manure_nutrient_excretion_ipcc import LivestockManureNutrientExcretionIPCCEngine

class LivestockManureNutrientExcretionIPCCEngineController:
    """Controller for LivestockManureNutrientExcretionIPCCEngine."""

    def __init__(self, service=None):
        self.service = service or LivestockManureNutrientExcretionIPCCEngine()
