"""
OrganicCoverCropNitrogenReleaseEngine Controller.
REST API controllers for Cover Crop Residue Carbon-Nitrogen Decomposition & N Release.
"""

from flask import jsonify, request
from app.services.agronomy.organic_cover_crop_nitrogen_release import OrganicCoverCropNitrogenReleaseEngine

class OrganicCoverCropNitrogenReleaseEngineController:
    """Controller for OrganicCoverCropNitrogenReleaseEngine."""

    def __init__(self, service=None):
        self.service = service or OrganicCoverCropNitrogenReleaseEngine()
