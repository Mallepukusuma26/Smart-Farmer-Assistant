"""
Soil Salinity ECe & ESP Gypsum Reclamation Engine Controller.
API endpoints for domain calculations and scenario evaluations.
"""

from flask import jsonify, request
from app.services.agronomy.soil_salinity_esp_reclamation_engine import SoilSalinityReclamationEngine

class SoilSalinityReclamationEngineController:
    """Controller for SoilSalinityReclamationEngine."""

    def __init__(self, engine=None):
        self.engine = engine or SoilSalinityReclamationEngine()
