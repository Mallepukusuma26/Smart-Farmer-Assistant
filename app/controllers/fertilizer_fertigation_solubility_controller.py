"""
Fertigation Salt Index & Hydroponic Solubility Engine Controller.
API endpoints for domain calculations and scenario evaluations.
"""

from flask import jsonify, request
from app.services.agronomy.fertilizer_fertigation_solubility_engine import FertigationSolubilityEngine

class FertigationSolubilityEngineController:
    """Controller for FertigationSolubilityEngine."""

    def __init__(self, engine=None):
        self.engine = engine or FertigationSolubilityEngine()
