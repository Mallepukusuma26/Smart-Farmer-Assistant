"""
Thermal Time & Phenology Stage Transition Engine Controller.
API endpoints for domain calculations and scenario evaluations.
"""

from flask import jsonify, request
from app.services.agronomy.crop_phenology_thermal_time_engine import ThermalTimePhenologyEngine

class ThermalTimePhenologyEngineController:
    """Controller for ThermalTimePhenologyEngine."""

    def __init__(self, engine=None):
        self.engine = engine or ThermalTimePhenologyEngine()
