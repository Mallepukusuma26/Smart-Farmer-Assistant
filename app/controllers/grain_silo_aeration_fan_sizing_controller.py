"""
GrainSiloAerationFanSizingEngine Controller.
REST API controllers for Airflow Rate (m3/min/ton) & Static Pressure Drop Fan Sizing.
"""

from flask import jsonify, request
from app.services.agronomy.grain_silo_aeration_fan_sizing import GrainSiloAerationFanSizingEngine

class GrainSiloAerationFanSizingEngineController:
    """Controller for GrainSiloAerationFanSizingEngine."""

    def __init__(self, service=None):
        self.service = service or GrainSiloAerationFanSizingEngine()
