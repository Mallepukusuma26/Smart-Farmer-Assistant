"""
PipeFrictionHazenWilliamsEngine Controller.
REST API controllers for Hazen-Williams Pipe Head Loss & Pressure Drop Calculator.
"""

from flask import jsonify, request
from app.services.agronomy.pipe_friction_hazen_williams import PipeFrictionHazenWilliamsEngine

class PipeFrictionHazenWilliamsEngineController:
    """Controller for PipeFrictionHazenWilliamsEngine."""

    def __init__(self, service=None):
        self.service = service or PipeFrictionHazenWilliamsEngine()
