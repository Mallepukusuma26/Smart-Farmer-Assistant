"""
FAO-33 Water Production Function Yield Engine Controller.
API endpoints for domain calculations and scenario evaluations.
"""

from flask import jsonify, request
from app.services.agronomy.crop_yield_water_production_function_engine import CropWaterYieldFunctionEngine

class CropWaterYieldFunctionEngineController:
    """Controller for CropWaterYieldFunctionEngine."""

    def __init__(self, engine=None):
        self.engine = engine or CropWaterYieldFunctionEngine()
