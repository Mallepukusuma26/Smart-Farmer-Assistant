"""
WatershedFarmPondHarvestingCapacityEngine Controller.
REST API controllers for Rainwater Harvesting Farm Pond Storage Sizing & Evaporation Loss.
"""

from flask import jsonify, request
from app.services.agronomy.watershed_farm_pond_harvesting_capacity import WatershedFarmPondHarvestingCapacityEngine

class WatershedFarmPondHarvestingCapacityEngineController:
    """Controller for WatershedFarmPondHarvestingCapacityEngine."""

    def __init__(self, service=None):
        self.service = service or WatershedFarmPondHarvestingCapacityEngine()
