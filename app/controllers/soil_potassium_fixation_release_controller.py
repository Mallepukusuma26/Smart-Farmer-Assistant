"""
SoilPotassiumFixationReleaseEngine Controller.
REST API controllers for Non-Exchangeable Clay Mineral Potassium Weathering Kinetics.
"""

from flask import jsonify, request
from app.services.agronomy.soil_potassium_fixation_release import SoilPotassiumFixationReleaseEngine

class SoilPotassiumFixationReleaseEngineController:
    """Controller for SoilPotassiumFixationReleaseEngine."""

    def __init__(self, service=None):
        self.service = service or SoilPotassiumFixationReleaseEngine()
