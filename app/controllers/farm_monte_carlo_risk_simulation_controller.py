"""
FarmMonteCarloRiskSimulationEngine Controller.
REST API controllers for Stochastic Monte Carlo Yield & Price Risk Value at Risk (VaR).
"""

from flask import jsonify, request
from app.services.agronomy.farm_monte_carlo_risk_simulation import FarmMonteCarloRiskSimulationEngine

class FarmMonteCarloRiskSimulationEngineController:
    """Controller for FarmMonteCarloRiskSimulationEngine."""

    def __init__(self, service=None):
        self.service = service or FarmMonteCarloRiskSimulationEngine()
