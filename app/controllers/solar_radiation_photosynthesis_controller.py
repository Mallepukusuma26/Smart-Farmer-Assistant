"""
Photosynthetic Radiation & Canopy Light Extinction Engine Controller.
API endpoints for domain calculations and scenario evaluations.
"""

from flask import jsonify, request
from app.services.agronomy.solar_radiation_photosynthesis_engine import CanopyPhotosynthesisEngine

class CanopyPhotosynthesisEngineController:
    """Controller for CanopyPhotosynthesisEngine."""

    def __init__(self, engine=None):
        self.engine = engine or CanopyPhotosynthesisEngine()
