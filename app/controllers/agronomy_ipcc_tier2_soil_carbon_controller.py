"""
AgronomyIPCCTier2SoilCarbonEngine Controller.
"""

from flask import jsonify, request
from app.services.agronomy.agronomy_ipcc_tier2_soil_carbon import AgronomyIPCCTier2SoilCarbonEngine

class AgronomyIPCCTier2SoilCarbonEngineController:
    def __init__(self, service=None):
        self.service = service or AgronomyIPCCTier2SoilCarbonEngine()
