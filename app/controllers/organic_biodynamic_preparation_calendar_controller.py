"""
OrganicBiodynamicPreparationCalendarEngine Controller.
REST API controllers for Astrological Lunar Cycle & Biodynamic Soil Preparation Timing.
"""

from flask import jsonify, request
from app.services.agronomy.organic_biodynamic_preparation_calendar import OrganicBiodynamicPreparationCalendarEngine

class OrganicBiodynamicPreparationCalendarEngineController:
    """Controller for OrganicBiodynamicPreparationCalendarEngine."""

    def __init__(self, service=None):
        self.service = service or OrganicBiodynamicPreparationCalendarEngine()
