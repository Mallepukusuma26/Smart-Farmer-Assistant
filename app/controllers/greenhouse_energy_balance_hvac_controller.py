"""
GreenhouseEnergyBalanceHVACEngine Controller.
REST API controllers for Glazing Thermal Loss & Solar Heat Gain Heating Load Sizing.
"""

from flask import jsonify, request
from app.services.agronomy.greenhouse_energy_balance_hvac import GreenhouseEnergyBalanceHVACEngine

class GreenhouseEnergyBalanceHVACEngineController:
    """Controller for GreenhouseEnergyBalanceHVACEngine."""

    def __init__(self, service=None):
        self.service = service or GreenhouseEnergyBalanceHVACEngine()
