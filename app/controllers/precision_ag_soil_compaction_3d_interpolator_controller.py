"""
PrecisionAgSoilCompaction3DInterpolatorEngine Controller.
REST API controllers for 3D Soil Penetrometer Resistance Depth Profile Interpolator.
"""

from flask import jsonify, request
from app.services.agronomy.precision_ag_soil_compaction_3d_interpolator import PrecisionAgSoilCompaction3DInterpolatorEngine

class PrecisionAgSoilCompaction3DInterpolatorEngineController:
    """Controller for PrecisionAgSoilCompaction3DInterpolatorEngine."""

    def __init__(self, service=None):
        self.service = service or PrecisionAgSoilCompaction3DInterpolatorEngine()
