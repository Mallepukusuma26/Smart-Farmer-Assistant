"""
LivestockHeatStressTHIEngine Controller.
REST API controllers for Temperature-Humidity Index (THI) Livestock Heat Stress.
"""

from flask import jsonify, request
from app.services.agronomy.livestock_heat_stress_thi_index import LivestockHeatStressTHIEngine

class LivestockHeatStressTHIEngineController:
    """Controller for LivestockHeatStressTHIEngine."""

    def __init__(self, service=None):
        self.service = service or LivestockHeatStressTHIEngine()
